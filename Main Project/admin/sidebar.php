...
<div class="sidebar" ><b>
  ...
  <a href="query.php"   <?php if($active=='query') echo "class='act'"; ?>><span class="glyphicon glyphicon-list-alt"></span>&nbsp&nbspContact Info</a>
  ...
  <a href="meeting.php"   <?php if($active=='active') echo "class='act'"; ?>><span class="glyphicon glyphicon-edit"></span>&nbsp&nbspUpdate Meeting Booked</a>
