...
<div id="sidebar">
<?php $active="meeting"; include 'sidebar.php'; ?>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <th style="text-align:center">Donor Place</th>
          <th style="text-align:center">Donor Blood</th>
          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_blood']; ?></td>
                    ...
                    <a style="background-color:aqua" href='delete2.php?id=<?php echo $row['id']; ?>'> Delete </a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
