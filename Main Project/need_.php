...
<style>
    body {
      background-image: url("./image/need.png");
...
<body>
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-4 mb-3">Need Donors</h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Please Give the contact and medical history?<span style="color:red">*</span></div>
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="card" style="width:300px">
          ...
          <div class="card-body">
            ...
            <a href="booking.php?donor=<?php echo $donorid ?>">Book meeting</a>
